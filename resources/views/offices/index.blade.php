<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            @role('Super Admin')
                <div class="ml-4">
                    <a href="{{ route('offices.manage') }}" class="bg-white/10 hover:bg-white/20 text-white border border-white/20 px-4 py-2 rounded-lg text-sm font-semibold flex items-center gap-2 transition">
